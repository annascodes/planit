...
const TaskCard = ({ task }) => {
  ...
  return (
    <div className="border border-black duration-500 p-3 rounded-xl  min-w-80 md:min-w-96 max-w-96 bg-white  ">
      ...
      <div className=" ">
        <Link to={`/taskdetails/${task?._id}`} className="">
          ...
          <h1
            className={` hover:text-blue-500 text-md  duration-200 ${
      ...
      <div className="border-0 min-h-24">
            ...
            task?.subtasks[i] && (
              <div className="my-2">
                <h1 className="flex text-sm">
                  ...
                  <span
                    className={`ml-2 flex flex-row justify-between w-full ${
                      task?.subtasks[i].status === "completed" && "line-through"
                    }`}
                  >
